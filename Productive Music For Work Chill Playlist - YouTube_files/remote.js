...
L:"ytp-mdx-manual-pairing-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",va:"Pronto dejar\u00e1 de ser posible establecer una conexi\u00f3n web con una TV mediante un c\u00f3digo"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",U:[{G:"button",Ga:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],va:"M\u00e1s informaci\u00f3n"},{G:"button",Ga:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
va:"Aceptar"}]}]}]});this.i=new g.zL(this,250);this.learnMoreButton=this.Fa("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.Fa("ytp-mdx-manual-pairing-popup-ok");g.J(this,this.i);this.T(this.learnMoreButton,"click",this.u);this.T(this.okButton,"click",this.B)},C9=function(){g.U.call(this,{G:"div",
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",va:"No has iniciado sesi\u00f3n"},{G:"div",L:"ytp-mdx-popup-description",va:"Los v\u00eddeos que veas podr\u00edan aparecer en el historial de reproducciones de la TV e influir en las recomendaciones. Puedes evitarlo si cancelas e inicias sesi\u00f3n en YouTube desde tu ordenador."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],
va:"Cancelar"},{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"Confirmar"}]}]}]});this.i=new g.zL(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.J(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},D9=function(a){g.U.call(this,{G:"div",
...
b=g.T(b,128)?g.qI("No se ha podido reproducir el v\u00eddeo en $RECEIVER_NAME",c):b.Ac()||g.T(b,4)?g.qI("El v\u00eddeo se est\u00e1 reproduciendo en $RECEIVER_NAME",c):g.qI("Conectado a $RECEIVER_NAME",c);a.Ra("statustext",b);a.i.show()}else a.i.hide()},E9=function(a,b){g.NP.call(this,"Reproducir en",0,a,b);
...
E9.prototype.bj=function(a){return"cast-selector-receiver"===a?"Reparto...":this.oo[a].name};
